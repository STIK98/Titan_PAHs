...
if __name__ == "__main__":
    ...
    version_choice = "1.20"  # Use version 1.20 for this run
    neutral_choice = "test_gof_rchi2"  # Only neutral PAHs
    ...
    search_query2 = "mg=0 fe=0 si=0 o=0 h>0 anion"  # Only neutral PAHs
    uids2 = pahdb.search(search_query2)
    transitions = pahdb.gettransitionsbyuid(uids1 + uids2)
    transitions = pahdb.gettransitionsbyuid([527])
