...
if __name__ == "__main__":
    ...
    neutral_choice = "testing"  # Only neutral PAHs
    ...
    pahdb = AmesPAHdb(
        ...
        # --- PAH Search ---
    search_query1 = "mg=0 fe=0 si=0 o=0 h>0 neutral c<28"  # Only cationic PAHs
    # Perform the search
    uids1 = pahdb.search(search_query1)
    search_query2 = "mg=0 fe=0 si=0 o=0 h>0 anion c<28"  # Only neutral PAHs
    ...
    for height in heights:
        ...
        NNLCfit = spectrum.fit(obs, normalization="max")
